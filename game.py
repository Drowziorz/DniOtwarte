...
def generate_random_fruits(fruit):
    ...
    data[fruit] = {
        ...
        'speed_y': random.randint(-60, -50),    #control the speed of fruits in y-directionn ( UP )
    ...
    if random.random() >= 0.97:     #Return the next random floating point number in the range [0.0, 1.0) to keep the fruits inside the gameDisplay
